<script lang="ts">
  ...
  // Función para manejar el callback de Google (se llama desde la página de callback)
  export async function handleGoogleCallback(code: string) {
    ...
    try {
      ...
      success = 'Conectado con Google con éxito';
      ...
      error = err instanceof Error ? err.message : 'Error en autenticación con Google';
      throw err;
    } finally {
      isLoading = false;
    }
